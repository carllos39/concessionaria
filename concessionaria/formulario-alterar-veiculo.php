...
alterarVeiculo($conexao,$id,$nome,$marca,$ano,$valor,$combustivel,$desconto,$total);
...
<body>
    ...
    <h1>Concessionária Carango Velho</h1>
        <nav class="navegacao">
            <ul class="menu">
                ...
                <li><a href="formulario-cadastra-veiculo.php">Cadastrar</a></li>
    ...
    <div>
            <label for="id"> Id do veiculo :</label>
        ...
        <input type="submit" name="alterar" value="Alterar veiculo">
